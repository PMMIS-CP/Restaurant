...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800">
                    ویرایش دسته‌بندی: {{ $menuCategory->name_fa }} - {{ $menuCategory->name_en }} - {{ $menuCategory->name_ar }}
                </h2>
        ...
        <!-- Form -->
        <form action="{{ route('admin.menu-categories.update', $menuCategory) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" 
                       name="name_fa" 
                       id="name_fa" 
                       value="{{ old('name_fa', $menuCategory->name_fa) }}"
            ...
            <div>
                ...
                <input type="text" 
                       name="name_en" 
                       id="name_en" 
                       value="{{ old('name_en', $menuCategory->name_en) }}"
            ...
            <div>
                ...
                <input type="text" 
                       name="name_ar" 
                       id="name_ar" 
                       value="{{ old('name_ar', $menuCategory->name_ar) }}"
