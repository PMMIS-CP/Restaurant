...
class MenuController extends Controller
{
    public function index()
    {
        ...
        // افزودن فیلدهای آماده برای نمایش در ویو
        $menu = array_map(function ($item) {
            $imageNumber = fmod($item['ردیف'] - 1, 12) + 1;
            $item['image_path'] = asset("assets/images/menu/" . $imageNumber . ".webp");
            $item['formatted_price'] = self::formatPrice($item['قیمت']);
            $item['formatted_price_full'] = self::formatPriceFull($item['قیمت']);
            return $item;
        }, $menu);
        ...
        // تصاویر متناظر با هر دسته‌بندی (بر اساس نام دسته)
        $categoryImages = [];
    ...
    // توابع کمکی فرمت قیمت (به‌عنوان متد خصوصی کنترلر)
