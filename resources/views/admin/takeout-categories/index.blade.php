{{-- resources/views/admin/takeout-categories/index.blade.php --}}
    ...
    <div class="p-6 border-b border-gray-200">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.takeout-categories.create') }}" 
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs">
                            {{ $category->takeouts_count }} غذا
                        </span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <div class="flex space-x-3 rtl:space-x-reverse">
                            <a href="{{ route('admin.takeout-categories.edit', $category) }}" 
                            ...
                            <form action="{{ route('admin.takeout-categories.destroy', $category) }}" 
                                  method="POST" 
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                        ...
                        <a href="{{ route('admin.takeout-categories.create') }}" class="text-rose-500 hover:text-rose-600 mt-2 inline-block">
