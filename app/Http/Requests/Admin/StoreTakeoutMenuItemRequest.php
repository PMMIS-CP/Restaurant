...
class StoreTakeoutMenuItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'menu_takeout_category_id'=> ['required', 'integer', 'exists:menu_takeout_categories,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'menu_takeout_category_id.required' => 'انتخاب دسته‌بندی الزامی است.',
            'menu_takeout_category_id.exists'   => 'دسته‌بندی انتخاب‌شده معتبر نیست.',
