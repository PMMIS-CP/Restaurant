{{-- resources/views/admin/organizational-categories/create.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'ایجاد دسته‌بندی جدید (سازمانی)')
    ...
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800">ایجاد دسته‌بندی جدید (سازمانی)</h2>
        ...
        <!-- Form -->
        <form action="{{ route('admin.organizational-categories.store') }}" method="POST" class="p-6 space-y-6" id="category-form">
            @csrf
