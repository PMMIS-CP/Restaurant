...
<div class="bg-white rounded-lg shadow-lg">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.takeout.create') }}" 
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <div class="flex space-x-3 rtl:space-x-reverse">
                            <a href="{{ route('admin.takeout.edit', $item) }}" class="text-blue-600 hover:text-blue-900">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                          d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </a>
                            <form action="{{ route('admin.takeout.destroy', $item) }}" method="POST" 
                ...
                <tr>
                    <td colspan="8" class="px-6 py-12 text-center text-gray-500">
                        ...
                        <a href="{{ route('admin.takeout.create') }}" class="text-rose-500 hover:text-rose-600 mt-2 inline-block">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    toggleSwitches.forEach(toggle => {
        toggle.addEventListener('change', function() {
            ...
            fetch(`/admin/takeout/${id}/toggle-active`, {
                method: 'PATCH',
                headers: {
