<section class="relative overflow-hidden bg-linear-to-b from-[#FFF8E7] to-[#FDF3E1] py-12 sm:py-16 md:py-24">
    ...
    <div class="container mx-auto px-4 sm:px-6">
        <div class="mb-8 sm:mb-10 md:mb-12 text-center md:text-start">
            <span class="inline-block rounded-full bg-[#C41E3A]/10 px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-semibold text-[#8B1A2B] ring-1 ring-[#D4AF37]/40">درباره کاخ موراکو</span>
            <p class="mt-2 sm:mt-3 text-lg sm:text-xl font-bold text-[#3E2723] md:text-2xl">قصه‌ای از طعم‌های اصیل و آداب باشکوه دربار</p>
        </div>
        <div class="flex flex-col items-center gap-8 sm:gap-10 md:gap-12 md:flex-row">
            <div class="w-full text-center md:w-1/2 md:text-start">
                <h2 class="text-2xl sm:text-3xl font-extrabold text-[#5D1A1A] md:text-4xl lg:text-5xl">
