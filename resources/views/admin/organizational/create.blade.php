{{-- resources/views/admin/organizational/create.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'افزودن غذای جدید (سازمانی)')
    ...
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold text-gray-800">افزودن غذای جدید (سازمانی)</h2>
        ...
        <!-- Form -->
        <form action="{{ route('admin.organizational.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <select name="menu_organizational_category_id" id="menu_organizational_category_id" 
                    ...
                    @foreach($categories as $category)
                        <option value="{{ $category->id }}" {{ old('menu_organizational_category_id') == $category->id ? 'selected' : '' }}>
                            {{ $category->name_fa }}
                        </option>
                    @endforeach
                </select>
                ...
                @if($categories->isEmpty())
                    <p class="mt-2 text-sm text-yellow-600">
                        ...
                        <a href="{{ route('admin.organizational-categories.create') }}" class="underline text-rose-500">یک دسته جدید بسازید</a>.
                    </p>
                @endif
            </div>
