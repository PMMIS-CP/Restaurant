...
class MenuTakeout extends Model
{
    protected $fillable = [
        'name',
        'description',
        'price',
        'menu_takeout_category_id',
        'images',
        'is_active',
        'sort_order',
    ];
    ...
    /**
     * رابطه با دسته‌بندی بیرون‌بر
     */
    public function category()
    {
        return $this->belongsTo(MenuTakeoutCategory::class, 'menu_takeout_category_id');
    }
